...
export default function LandingPage() {
    ...
    return (
        <div className="flex flex-col p-4 gap-4">
            <div className="flex w-full justify-center items-center pt-48 pb-6">
            ...
            <div className="flex w-full justify-center items-center tracking-[-0.075em] pb-0.5">
                ...
                <h1 className="text-7xl font-black italic text-primary ml-3">byte</h1>
            </div>
            <h3 className="text-center text-black text-opacity-80 text-lg font-light">Meet your AI social media manager</h3>
