...
export default function MobileNavbar() {
    ...
    return (
        <div className="fixed flex justify-between items-center w-full h-12 px-10 bottom-0 left-0 right-0 bg-white drop-shadow-sexy z-50">
            <Link href="/app">
                <img src={active === "/app" ? "/icons/navbar/2/home.svg" : "/icons/navbar/home.svg"} onClick={() => setActive("/app")} alt="Home" width={24} height={24} />
            </Link>
            <Link href="/app/context">
                <img src={active === "/app/context" ? "/icons/navbar/2/context.svg" : "/icons/navbar/context.svg"} onClick={() => setActive("/app/context")} alt="Context" width={24} height={24} />
            </Link>
            <Link href="/app/create-post">
                <img src={active === "/app/create-post" ? "/icons/navbar/2/plus.svg" : "/icons/navbar/plus.svg"} onClick={() => setActive("/app/create-post")} alt="Create" width={24} height={24} />
            </Link>
            <Link href="/app/scheduling">
                <img src={active === "/app/scheduling" ? "/icons/navbar/2/scheduling.svg" : "/icons/navbar/scheduling.svg"} onClick={() => setActive("/app/scheduling")} alt="Scheduling" width={24} height={24} />
            </Link>
            <Link href="/app/ai">
                <img src={active === "/app/ai" ? "/icons/navbar/2/ai.svg" : "/icons/navbar/ai.svg"} onClick={() => setActive("/app/ai")} alt="AI" width={20} height={20} />
            </Link>
